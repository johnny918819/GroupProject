...
namespace GroupProject.Migrations
{
    ...
    [Migration("20170406002413_newBuild2")]
    partial class newBuild2
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("GroupProject.Models.EventMeetUp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GroupProject.Models.ApplicationUser", b =>
                {
                    b.HasOne("GroupProject.Models.EventMeetUp")
                        .WithMany("Attendees")
                        .HasForeignKey("EventMeetUpId");
                });
